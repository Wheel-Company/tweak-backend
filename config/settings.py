...
BATON = {
    ...
    'MENU': (
        ...
        { 'type': 'free', 'label': 'Custom Link', 'url': 'https://tweak-english.com', 'perms': ('flatpages.add_flatpage', 'auth.change_user') },
        { 'type': 'free', 'label': 'My parent voice', 'default_open': True, 'children': [
            { 'type': 'model', 'label': 'A Model', 'name': 'mymodelname', 'app': 'myapp' },
            { 'type': 'free', 'label': 'Another custom link', 'url': 'https://tweak-english.com' },
        ] },
    ),
    # 'ANALYTICS': {
